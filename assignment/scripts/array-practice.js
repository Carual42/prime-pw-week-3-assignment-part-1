...
let foodArray = ['tacos', 'burgers', 'pasta', 'sushi'];
// 1.b. TODO: Log your array of foods to the console with a message, similar 
//      to the example above
console.log('My favorite food is ', foodArray)
...
console.log('The favorite food is now', foodArray);
...
foodArray.unshift('Stir fry');
console.log(`Added a dish to the beginning: ${foodArray}`);
...
console.log('Removed the first meal', removedFood);
console.log('The meals are now', foodArray);
...
let isItFoodOrPet = foodArray.concat(animalArray)
console.log(isItFoodOrPet)